...
enum L10n {
    ...
    static let predefinedFourByFourTitle = String(localized: "Four by Four", comment: "Predefined interval title")
    static let predefinedThresholdSixesTitle = String(localized: "Threshold Sixes", comment: "Predefined interval title")
    static let predefinedThousandRepeatsTitle = String(localized: "Thousand Repeats", comment: "Predefined interval title")
    ...
    static let predefinedFourHundredRepeatsTitle = String(localized: "Four Hundred Repeats", comment: "Predefined interval title")
    static let predefinedStructuredFartlekTitle = String(localized: "Structured Fartlek", comment: "Predefined interval title")
    static let predefinedLongTwelvesTitle = String(localized: "Long Twelves", comment: "Predefined interval title")
