...
enum L10n {
    ...
    static let introStartOnWatchTitle = String(localized: "Start where it makes sense", comment: "Companion intro page title")
    static let introStartOnWatchBody = String(localized: "Build your session on iPhone when you want to think it through, or head straight to Apple Watch when you are already warming up. Once you start, the watch keeps everything close at hand.", comment: "Companion intro page body")
    static let introLapsTitle = String(localized: "Mark every lap clearly", comment: "Companion intro page title")
    static let introLapsBody = String(localized: "Each lap should be marked with a button press on Apple Watch, or with the Action Button when your watch supports it. That keeps your workout structure clean, stores the laps in Apple Health, and syncs the same laps back to this app.", comment: "Companion intro page body")
    ...
    static let helpSessionPlanExample = String(localized: "Example: load last week's 6 × 400 m from History, then adjust one rest before your next run.", comment: "Companion help card example")
    static let helpRestTitle = String(localized: "Rest & Rest Mode", comment: "Companion help card title")
    static let helpRestBody = String(localized: "Rest is always attached to the lap you just finished, so it stays part of the workout.", comment: "Companion help card body")
    ...
    static let helpRestTip = String(localized: "Tip: use Manual when you want full control. Use Auto-detect when you want Rundr to enter rest after you stop and end it again when you move.", comment: "Companion help card tip")
    static let helpAutoRestTitle = String(localized: "How Auto Rest Works", comment: "Companion help card title")
    ...
    static let helpAutoRestExample = String(localized: "Example: finish a 400 m rep, stop at the rail, and the current lap becomes rest. When you are ready for the next rep, press lap to start the next lap.", comment: "Companion help card example")
    ...
    static let helpDistanceTypeOpenExample = String(localized: "Example: choose Open for 45 s with 15 s rest.", comment: "Companion help card example")
