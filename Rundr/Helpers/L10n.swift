...
enum L10n {
    ...
    static let helpRestTip = String(localized: "Tip: use Manual when you want to choose exactly when Mark as Rest starts and ends. Use Auto-detect when you want Rundr to enter rest after you stop and end it again when you move.", comment: "Companion help card tip")
