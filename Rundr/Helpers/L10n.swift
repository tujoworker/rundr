...
enum L10n {
    ...
    static let adjustSettings = String(localized: "Adjust Session", comment: "History setup title")
    ...
    static let myIntervals = String(localized: "My Sessions", comment: "Interval library title")
    static let newInterval = String(localized: "New Session", comment: "Title for creating a new interval preset")
    static let addInterval = String(localized: "Add Session", comment: "Accessibility label for adding a new interval preset")
    ...
    static let description = String(localized: "Description", comment: "Preset description label")
    ...
    static let predefinedFortyFiveFifteensDescription = String(localized: "20-30 x (45s / 15s), continuous or 2 sets. Maximum threshold time with micro-recovery. High quality without full fatigue.", comment: "Predefined interval description")
    ...
    static let predefinedOverUnderDescription = String(localized: "4 x 8 min alternating 1 min over / 1 min under. Under is around half marathon to threshold feel, over is around 10K effort. Trains lactate handling and pace changes.", comment: "Predefined interval description")
    ...
    static let predefinedFourHundredRepeatsDescription = String(localized: "10 x 400 m / 90s active recovery, split sets optional. Speed plus running economy. Classic and effective.", comment: "Predefined interval description")
    ...
    static let noSavedIntervalsYet = String(localized: "No saved sessions yet", comment: "Empty saved intervals state")
    static let savedIntervalsPlaceholderDetail = String(localized: "Open a predefined session to save your own version.", comment: "Browse empty state guidance for saved intervals")
    ...
    static let editInterval = String(localized: "Edit Session", comment: "Companion segment editor title")
    ...
    static let recovery = String(localized: "Recovery", comment: "Short recovery label for space-constrained interval cells")
    ...
    static let planImportedMessage = String(localized: "The plan was added to My Sessions.", comment: "Companion import success message for plans")
    ...
    static let introStartOnWatchBody = String(localized: "Build your Session Plan on iPhone, or load one from a predefined intervals list, then head to Apple Watch when you are ready to run.", comment: "Companion intro page body")
    static let introPlanTitle = String(localized: "Use a Session Plan", comment: "Companion intro page title")
    static let introPlanBody = String(localized: "Use a Session Plan to shape your workout session. You can go by time or predefined manual distance, which gives you more precise lap reports and pace data later.", comment: "Companion intro page body")
    ...
    static let introRestTitle = String(localized: "Active Recovery or a Rest", comment: "Companion intro page title")
    static let introRestBody = String(localized: "These are tied to a lap, so your workout history stays readable.", comment: "Companion intro page body")
    static let introAppearanceBody = String(localized: "Choose whether Rundr follows the system, stays light, or uses Dark Mode before you start.", comment: "Companion intro page body")
    static let introColorTitle = String(localized: "Pick your color", comment: "Companion intro page title")
    static let introColorBody = String(localized: "Choose the accent that feels right before you start.", comment: "Companion intro page body")
    static let introSyncAndRepeatTitle = String(localized: "Bring good sessions back", comment: "Companion intro page title")
    static let introSyncAndRepeatBody = String(localized: "When your session is done, it syncs automatically to iPhone and can be shared from there. Reuse the ones that worked and adjust the ones that did not.", comment: "Companion intro page body")
    ...
    static let helpSharingBody = String(localized: "Rundr exports plans and past sessions as files from the iPhone share sheet. Use Share Plan in Adjust Session to send a plan, or Share Session in a past session detail view to send a session.", comment: "Companion help card body")
    ...
    static let helpLastRestTitle = String(localized: "Last Rest", comment: "Companion help card title")
    static let helpLastRestBody = String(localized: "Last Rest lets the final repeat use a different rest duration than the earlier repeats.", comment: "Companion help card body")
    static let helpLastRestWhenHeading = String(localized: "When It Applies", comment: "Companion help section heading")
    static let helpLastRestWhenBody = String(localized: "Rundr only uses Last Rest on the final repeat of an interval that has repeats. Add repeats first, then set Last Rest if you want a different recovery before the workout moves on.", comment: "Companion help section body")
    static let helpLastRestWhyHeading = String(localized: "Why Use It", comment: "Companion help section heading")
    static let helpLastRestWhyBody = String(localized: "Use Last Rest when most repeats should share one recovery, but the final recovery should be shorter, longer, or off before the next segment or cooldown.", comment: "Companion help section body")
    static let helpLastRestExample = String(localized: "Example: 6 x 400 m with 60 s rest and 2 min Last Rest keeps 60 s between repeats, then gives you 2 min after the last one.", comment: "Companion help card example")
