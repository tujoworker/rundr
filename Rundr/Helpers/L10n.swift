...
enum L10n {
    ...
    static let introRestBody = String(localized: "These are tied to a lap, so your workout history stays readable. Rundr can also detect rest automatically, which helps when you want the watch to follow the rhythm of the session.", comment: "Companion intro page body")
    static let introColorTitle = String(localized: "Pick your color", comment: "Companion intro page title")
    static let introColorBody = String(localized: "Choose the accent that feels right before you start. It carries through the companion and the watch, so Rundr feels like yours from the beginning.", comment: "Companion intro page body")
